...
const { proteksi, adminSaja, superAdminSaja } = require('../middleware/auth');
...
router.get('/laporan', async (req, res) => {
  try {
    ...
    console.error('laporan admin error:', error);
...
router.delete('/laporan/:id', async (req, res) => {
  try {
    ...
    console.error('hapus laporan error:', error);
...
router.post(
  ...
  try {
    ...
    console.error('buat admin error:', error);
